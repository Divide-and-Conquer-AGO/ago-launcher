...
func (myTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0x19, G: 0x19, B: 0x1a, A: 0xff}
	case theme.ColorNameButton:
		return color.NRGBA{R: 0x12, G: 0x12, B: 0x13, A: 0xff}
	case theme.ColorNameDisabledButton:
		return color.NRGBA{R: 0x28, G: 0x29, B: 0x2e, A: 0xff}
	case theme.ColorNameDisabled:
		return color.NRGBA{R: 0x39, G: 0x39, B: 0x3a, A: 0xff}
	case theme.ColorNameError:
		return color.NRGBA{R: 0xbc, G: 0x1d, B: 0x11, A: 0xff}
	case theme.ColorNameFocus:
		return color.NRGBA{R: 0xff, G: 0x98, B: 0x0, A: 0x7f}
	case theme.ColorNameForeground:
		return color.NRGBA{R: 0xf3, G: 0xa5, B: 0x10, A: 0xff}
	...
	case theme.ColorNamePrimary:
		return color.NRGBA{R: 0xae, G: 0x68, B: 0x0, A: 0xff}
